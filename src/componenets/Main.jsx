...
const Main = () => {
  return (
    <div className="main">
      ...
      <div className="right">
        <iframe width="450" height="270" src="https://www.youtube.com/embed/w7ejDZ8SWv8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
        <p>Check out the demo to get started</p>
      </div>
      </div>
      <hr style={{marginTop:"50px"}}/>
      <div className="downPart">
        <div className="heading"><p>Games created using Wuri</p></div>
        <div className="image">
